...
def main():
    ...
    info_interval = 1
    eval_interval = 1
    TRAIN_DATA_PATH = 'SegAE_data_50samples/train'
    VALID_DATA_PATH = 'SegAE_data_50samples/val'
    ...
    model = SegAE(hidden_dim=50, backbone=model_name, embedding='text_embedding').to(device)
